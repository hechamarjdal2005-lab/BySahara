      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 mt-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
          ...
          >
            ...
            <p className="text-sm leading-relaxed" style={{ color: '#442413' }}>
              {description}
            </p>
          </div>
            ...
            <div className="space-y-3">
              ...
              {cooperative.memberCount && (
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-xs" style={{ color: '#442413' }}>
                    {cooperative.memberCount} {t('عضو', 'members')}
                  </p>
                </div>
              )}
              {cooperative.foundedYear && (
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-xs" style={{ color: '#442413' }}>
                    {t('تأسست', 'Founded')} {cooperative.foundedYear}
                  </p>
                </div>
              )}
              {cooperative.phone && (
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-3 mb-6">
          {impactItems.map((item) => (
            ...
            >
              ...
              <h4 className="font-bold text-xs mb-0.5" style={{ color: '#F8D197' }}>
                {item.title}
              </h4>
              <p style={{ fontSize: '0.6rem', color: '#F7E5CD', lineHeight: 1.3 }}>
                {item.desc}
              </p>
            </div>
          ))}
